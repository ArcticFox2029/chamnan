...
runs**; the index's own assertions about the tree check out at **3,735 of 3,735** <!-- live: map_claim_check -->; and **51.1%** of
...
more and needed no credential word in the markup at all. Assigning a credential-named variable
straight from `os.environ` was redacted while
...
claims about the tree are checked at **3,735 of 3,735** <!-- live: map_claim_check --> rather than asserted.
...
searched for, and its claims about the tree check out at **3,735 of 3,735** <!-- live: map_claim_check --> (`tools/map_claim_check.py`).
