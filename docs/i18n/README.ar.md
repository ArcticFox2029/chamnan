...
| | |
|---|---|
| **أي نموذج، وأي مزوّد** | الفهرس نصٌّ صِرف يُمرَّر كسياق. النموذج يغيّر فقط مقدار ما يستحقّ الإرسال، ولا يغيّر أبدًا موضع أي شيء. يُضبط الحجم بـ `--model` أو `--window` أو `--profile`. وتبديل النموذج لا يستلزم إعادة تثبيت شيء. |
